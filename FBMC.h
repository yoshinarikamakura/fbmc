...
//
    State selectStateOnIsoEnergySurface(const double energy, const Vector3 r, const double charge);
...
// std::array<double, 2> eh_pair_energies ....Energies of electron-hole pair generated by impact ionization
...
private:
    ...
    State selectStateAfterImpactIonization(const State initial_state, std::array<double, 2>& eh_pair_energies);
};
